...
import fragment.nav.FragmentMyMp3;
import fragment.nav.FragmentNghesi;
import fragment.nav.FragmentVideo;
import fragment.nav.Login;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dangnhap) {
            ...
            fragment = new FragmentMyMp3();
        }else if(id==R.id.nav_nhachot){
            fragment = new FragmentMusicHot();
        }else if (id==R.id.nav_album){
            fragment = new FragmentAlbum();
        }else if (id==R.id.nav_video){
            fragment = new FragmentVideo();
        }else if (id == R.id.nav_nghesi){
            fragment = new FragmentNghesi();
        }
